...
import { addNewMeasurement } from './statsWindow.js'
...
let recMeasureEnabled = false;
const recMeasure = document.querySelector( '#recMeasure' )
recMeasure.addEventListener("change", function(){
    if (recMeasure.checked){
...
let recAutoEnabled = false;
const recAuto = document.querySelector( '#autoMeasure' )
recAuto.addEventListener("change", function(){
    if (recAuto.checked){
        recAutoEnabled = true;
    }
    else{
